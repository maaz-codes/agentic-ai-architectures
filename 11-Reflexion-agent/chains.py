...
revise_responder = """Revise your previous answer using the new information.
...
revise_responder_chain = (
    actor_prompt_template.partial(first_instruction=revise_responder)
